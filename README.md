...
## 🗂 Структура проєкту
3d_platform/ ├── app/ │ ├── init.py # Ініціалізація Flask-додатку │ ├── models.py # SQLAlchemy-моделі │ ├── routes.py # Всі маршрути та логіка ├── templates/ # HTML-шаблони (Jinja2) │ ├── base.html │ ├── index.html │ ├── register.html │ ├── login.html │ ├── dashboard.html ├── static/ # CSS, JS, зображення ├── app.py # Точка запуску ├── site.db # SQLite база (створюється автоматично) ├── requirements.txt # Список залежностей └── README.md # Опис проєкту
